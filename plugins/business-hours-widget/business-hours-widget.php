<?php
/**
 * Business Hours Widget Widget Boilerplate
 *
 * The Inhabitent Widget Boilerplate is an organized, maintainable boilerplate for building widgets using WordPress best practices.
 *
 * Lightly forked from the WordPress Widget Boilerplate by @tommcfarlin.
 *
 * @package   Inhabitent_Business_Hours
 * @author    Matthew Cuthbert <matthew.cuthbert@live.com>
 * @license   GPL-2.0+
 ...
 * Plugin URI:        https://github.com/JelloPrint
 * Description:       Inhabitent Business Hours Wordpress Boilerplate
 * Version:           1.0.0
 * Author:            Matthew Cuthbert
 * Author URI:        https://github.com/JelloPrint
 * License:           GPL-2.0+
